...
export default function RegisterMember() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 p-4 py-20 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-teal-600/10 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-2xl relative z-10 animate-slideDown">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-400">Join your workspace as a designated Team Member.</p>
        </div>
